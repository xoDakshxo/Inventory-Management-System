...
def update_employee():
    ...
    c.execute("""UPDATE Employee SET
        ...
        WHERE oid = :oid""",
        {
            ...
            'street_name': street_name_editor.get(),
...
def edit_employee():
    ...
    # Create Text Boxes
    empid_editor = Entry(editor, width=30)
    ...
    house_no_editor = Entry(editor, width=30)
    house_no_editor.grid(row=3, column=1, padx=20)

    street_name_editor = Entry(editor, width=30)
...
houseno = Entry(root, width=30)
houseno.grid(row=4, column=1, padx=20)

streetnm = Entry(root, width=30)
...
submit_btn_e = Button(root, text="Add Record to Database", command=submit_employee)
submit_btn_e.grid(row=8, column=0, columnspan=2, pady=10, padx=10, ipadx=100)

# Create a Query button
query_btn_e = Button(root, text="Show Records", command=query_employee)
query_btn_e.grid(row=9, column=0, columnspan=2, pady=10, padx=10, ipadx=137)

# Create a Delete button
delete_btn_e = Button(root, text="Delete Record", command=delete_employee)
delete_btn_e.grid(row=12, column=0, columnspan=2, pady=10, padx=10, ipadx=136)

# Create an update button
edit_btn_e = Button(root, text="Edit Record", command=edit_employee)
edit_btn_e.grid(row=13, column=0, columnspan=2, pady=10, padx=10, ipadx=143)
...
def edit_purchases():
    ...
    edit_bt.grid(row=6, column=0, columnspan=2, pady=10, padx=10, ipadx=145)
...
def query_purchases():
    ...
    query_label1.grid(row=14, column=2,columnspan=2)
    conn.commit()
    conn.close()
...
delet_box_label.grid(row=11, column=2, pady=5)


# Create submit button
submit_btn_p = Button(root, text="Add Record to Database", command=submit_purchases)
submit_btn_p.grid(row=8, column=2, columnspan=2, pady=10, padx=10, ipadx=100)

# Create a Query button
query_btn_p = Button(root, text="Show Records", command=query_purchases)
query_btn_p.grid(row=9, column=2, columnspan=2, pady=10, padx=10, ipadx=137)

# Create a Delete button
delete_btn_p = Button(root, text="Delete Record", command=delete_purchases)
delete_btn_p.grid(row=12, column=2, columnspan=2, pady=10, padx=10, ipadx=136)

# Create an update button
edit_btn_p = Button(root, text="Edit Record", command=edit_purchases)
edit_btn_p.grid(row=13, column=2, columnspan=2, pady=10, padx=10, ipadx=143)
...
def edit_customers():
    ...
    edit_b.grid(row=8, column=0, columnspan=2, pady=10, padx=10, ipadx=145)
...
def query_customers():
    ...
    query_label2.grid(row=14, column=4,columnspan=2)
    conn.commit()
    conn.close()
...
houseno2 = Entry(root, width=30)
houseno2.grid(row=5, column=5, padx=20)

streetnm2 = Entry(root, width=30)
streetnm2.grid(row=6, column=5, padx=20)

city2 = Entry(root, width=30)
city2.grid(row=7, column=5, padx=20)

contact2 = Entry(root, width=30)
contact2.grid(row=8, column=5, padx=20)

dele_box = Entry(root, width=30)
dele_box.grid(row=11, column=5, pady=5)
...
dele_box_label.grid(row=11, column=4, pady=5)


# Create submit button
submit_btn_c = Button(root, text="Add Record to Database", command=submit_customers)
submit_btn_c.grid(row=9, column=4, columnspan=2, pady=10, padx=10, ipadx=100)

# Create a Query button
query_btn_c = Button(root, text="Show Records", command=query_customers)
query_btn_c.grid(row=10, column=4, columnspan=2, pady=10, padx=10, ipadx=137)

# Create a Delete button
delete_btn_c = Button(root, text="Delete Record", command=delete_customers)
delete_btn_c.grid(row=12, column=4, columnspan=2, pady=10, padx=10, ipadx=136)

# Create an update button
edit_btn_c = Button(root, text="Edit Record", command=edit_customers)
edit_btn_c.grid(row=13, column=4, columnspan=2, pady=10, padx=10, ipadx=143)
...
def edit_inventories():
    ...
    street_name_editor3 = Entry(editor3, width=30)
    street_name_editor3.grid(row=0, column=1, padx=20, pady=(10,0))

    city_editor3 = Entry(editor3, width=30)
    city_editor3.grid(row=1, column=1, padx=20)

    contact_editor3 = Entry(editor3, width=30)
    contact_editor3.grid(row=2, column=1, padx=20)

    owner_editor = Entry(editor3, width=30)
    ...
    edit_butt.grid(row=4, column=0, columnspan=2, pady=10, padx=10, ipadx=145)
...
def query_inventories():
    ...
    query_label3.grid(row=14, column=6,columnspan=2)
    conn.commit()
    conn.close()
...
del_box_label.grid(row=11, column=6, pady=5)

# Create submit button
submit_btn_i = Button(root, text="Add Record to Database", command=submit_inventories)
submit_btn_i.grid(row=9, column=6, columnspan=2, pady=10, padx=10, ipadx=100)

# Create a Query button
query_btn_i = Button(root, text="Show Records", command=query_inventories)
query_btn_i.grid(row=10, column=6, columnspan=2, pady=10, padx=10, ipadx=137)

# Create a Delete button
delete_btn_i = Button(root, text="Delete Record", command=delete_inventories)
delete_btn_i.grid(row=12, column=6, columnspan=2, pady=10, padx=10, ipadx=136)

# Create an update button
edit_btn_i = Button(root, text="Edit Record", command=edit_inventories)
edit_btn_i.grid(row=13, column=6, columnspan=2, pady=10, padx=10, ipadx=143)
